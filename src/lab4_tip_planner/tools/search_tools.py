...
def search_itinerary_blogs(
    ...
    queries = [
        f"itinerario {days} días {destination} ruta completa día a día blog 2024 OR 2025 OR 2026{exclude}",
        f"ruta {days} días {destination} en coche qué ver cada día blog{exclude}",
        f"{destination} {days - 1} OR {days} OR {days + 1} días itinerario completo día 1 día 2{exclude}",
        f"guía viaje {destination} {days} días ruta recomendada blog personal{exclude}",
    ]
